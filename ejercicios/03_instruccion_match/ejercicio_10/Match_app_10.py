...
class App(customtkinter.CTk):
    ...
    def btn_informar_on_click(self):
        ...
        match estacion:
            ...
            case "Otoño":
                match destino:
                    case "Bariloche" | "Cataratas" | "Mar del plata" | "Cordoba":
                        mensaje = mensaje_1
            case "Primavera":
                match destino:
                    case "Cataratas" | "Mar del plata" | "Cordoba":
                        mensaje = mensaje_1
                    case "Bariloche":
                        mensaje = mensaje_2
        alert(title="Precio final",message=estacion+" en "+destino+" = "+mensaje)
